...
Vid frågor kan ni kontakta: \\
  David Buhrman - \href{mailto:david.buhrman@ungaforskare.se}{david.buhrman@ungaforskare.se} \\
  Einar Bergviken - \href{mailto:einar.bergviken@ungaforskare.se}{einar.bergviken@ungaforskare.se} \\
  Nils Sjöstrand Berg - \href{mailto:nils.sjostrand.berg@ungaforskare.se}{nils.sjostrand.berg@ungaforskare.se}
...
\textbf{Material:} I filen \textit{material} som ligger i samma mapp som detta dokument finns detaljer om vad som ska skrivas ut
...
\end{itemize}
Allt material som används finns i Cybersecurity Academys OneDrive.
\section{Inledning (25 minuter)}
\textit{Material: Storyhäfte}
...
\begin{itemize}
    \item Analysering av myndighetens attackprofil
    \item Klassificering av information
    \item Mötet med generaldirektören (vägval)
\end{itemize}

Grupperna ska gå igenom attackprofilerna och hitta informationen om den tilldelade myndigheten. Utifrån detta ska de fylla i relevanta uppgifter i arbetshäftet och resonera kring hur informationen som hanteras av myndigheten borde klassificeras.

Grupperna ska sedan dokumentera sina slutsatsen och motivera sin val i ett möte med Generaldirektören (dvs. en handledare).

\subsection{1. Klassificering av information}

\textit{Material: Myndighetsklassificering}

Grupperna ska nu arbeta vidare med informationen om myndighetens centrala applikation. Uppgiften är att identifiera vilken typ av information som applikationen hanterar och beskriva denna kortfattat i det arbetshäftet.

Utifrån detta ska grupperna klassificera informationen enligt tre informationssä-kerhetsperspektiv: \textit{konfidentialitet}, \textit{riktighet} och \textit{tillgänglighet}. För varje perspektiv ska de ange vilken nivå som är lämplig samt kort motivera sitt val i arbetshäftet.

I sina motiveringar ska grupperna använda den givna attackprofilen för att resonera kring vilka konsekvenser det kan få om informationen exempelvis skulle läcka, förändras eller inte vara tillgänglig.
...
\textit{För att veta vilka incidenter varje grupp ska börja med tittar man på myndighetens attackprofil. Varje myndighet har ett ”största hot”. Längst ner på bladet kan man sedan se vilka attacker som är relevanta för just den hotaktören. När en grupp har blivit klar med sina uppgifter fortsätter de att arbeta med resterande incidenter.}

\subsection{2. Incidenthantering}
\textit{Material: Övningsmaterial}

Grupperna ska arbeta med de övningar som finns i alla mappar under "Övningsmaterial"-mappen i Akt 2. Instruktioner för varje övning finns i respektive uppgiftsbeskrivning.
